          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-xl md:text-2xl text-stone-600 mb-10 max-w-lg mx-auto md:mx-0 font-light">
                ...
                Save money, reduce waste, and eat deliciously.
              </p>
              ...
              <Link href="/dashboard">
                ...
                >
                  Start Cooking Now <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
            ...
            {/* Hero Image - Updated with a high-quality Indian Dish context */}
            <Card className="relative aspect-square md:aspect-4/5 border-4 border-stone-900 bg-stone-200 overflow-hidden py-0">
              <Image
                src="/paneer-butter-masala1.jpg" // Update this to a high-res Indian dish image
              ...
              <Card className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm border-2 border-stone-900 py-0">
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-4 text-xs text-stone-500 font-medium">
                    ...
                    <span className="flex items-center gap-1">
                      <Users className="w-3 h-3" /> 2-3 People
                    </span>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-4">
              Your Smart Desi Kitchen
            </h2>
            <p className="text-stone-600 text-xl font-light">
              Master the art of "Ghar ka swad" with cutting-edge AI.
            </p>
          </div>
